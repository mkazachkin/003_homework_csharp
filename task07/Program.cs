...
counter = 10;                               //Количество цифр в числе 10
do
...
Console.Write($"В числе {userNumber} - {counter} цифр");
if (counter == 1) Console.WriteLine("а.");
else if ((counter > 1) && (counter < 5)) Console.WriteLine("ы.");
